    ...
    <main className="min-h-screen">
      <section className="mx-auto max-w-7xl px-6 py-10">
        <motion.div
          ...
          className="mb-10"
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-black px-4 py-2 text-sm text-white">
            <ShieldCheck size={16} />
            FarmaChain Salvador
          </div>

          <h1 className="mt-6 max-w-4xl text-5xl font-semibold tracking-tight text-gray-950">
            Rastreabilidade farmacêutica com blockchain, QR Code, GPS e proteção de dados.
          </h1>

          <p className="mt-5 max-w-3xl text-lg leading-8 text-gray-600">
            Demonstração em tempo real de um medicamento da logística municipal:
            cadastro do lote, armazenamento na UBS, dispensação ao paciente,
            CPF criptografado e histórico auditável por QR Code.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <button
              onClick={resetDemo}
              disabled={loading}
              className="inline-flex items-center gap-2 rounded-full bg-black px-6 py-3 text-white transition hover:bg-gray-800"
            >
              <RefreshCw size={18} />
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-3">
          <Card className="lg:col-span-1">
            ...
            {selectedBatch ? (
              <div className="mt-5 space-y-3 text-sm">
                <p>
                  <strong>Medicamento:</strong> {selectedBatch.medicine_name}
                </p>
                <p>
                ...
                <p>
                  <strong>Estoque atual:</strong> {selectedBatch.quantity_current}
                </p>
                <p>
          ...
          <Card className="lg:col-span-2">
            <div className="flex items-center gap-3">
              <MapPin />
              <h2 className="text-xl font-semibold">Retirada com GPS</h2>
            </div>

            {trace?.batch ? (
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl bg-gray-50 p-4">
                  <p className="text-sm text-gray-500">Local de retirada</p>
        ...
        {dispensation && (
          <section className="mt-8">
            <Card>
              <div className="flex items-center gap-3">
                <ShieldCheck />
                <h2 className="text-xl font-semibold">Dispensação registrada com dados protegidos</h2>
              </div>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl bg-gray-50 p-4">
                  <p className="text-sm text-gray-500">Hash do bloco blockchain</p>
                  <p className="mt-2 break-all font-mono text-xs">
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-3">
          <Card>
            <div className="flex items-center gap-3">
              <QrCode />
              <h2 className="text-xl font-semibold">QR Code do lote</h2>
            </div>
